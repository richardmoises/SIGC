...
public class v02GestionarRol extends javax.swing.JInternalFrame {
    ...
    private void cargarDatosInicialesTabla1() {
        ...
        List<RolBE> listaRol = new Arraylist();
...
//----------------Para ocultar un columna (Columna NOMBRE)---------
        TBLROL.getColumnModel().getColumn(1).setMaxWidth(0);
        TBLROL.getColumnModel().getColumn(1).setMinWidth(0);
        TBLROL.getTableHeader().getColumnModel().getColumn(1).setMaxWidth(0);
        TBLROL.getTableHeader().getColumnModel().getColumn(1).setMaxWidth(0);
...
//----------------Para ocultar un columna (Columna DESCRIPCION)---------------------
...
//--------------------FALTA EL METODO MODIFYPERSONA--------------------------------
    ...
    private void TBLROLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TBLROLMouseClicked
        ...
        DESCTXT.setText(TBLROL.getValueAt(fila, 2).toString());
...
/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v02GestionarRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v02GestionarRol().setVisible(true);
            }
        });
    }
